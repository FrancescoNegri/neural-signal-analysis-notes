...
% \section{Spectral Analyses of Non-oscillatory Components}
% \graphicspath{ {./images/11/} }
% \input{sections/11_spectral_analyses_of_non_oscillatory_components.tex}
% \newpage

% \section{Time-Frequency Decomposition}
% \graphicspath{ {./images/12/} }
% \input{sections/12_time_frequency_decomposition.tex}
% \newpage

% \section{Event-related Potentials and Evoked Responses in LFPs}
% \graphicspath{ {./images/13/} }
% \input{sections/13_event_related_potentials_and_evoked_responses_in_LFPs.tex}
% \newpage
