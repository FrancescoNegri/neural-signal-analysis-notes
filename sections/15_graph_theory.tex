...
\paragraph{How can hubs be detected in brain networks?} In 2007, Sporns suggested that they should have:
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{15_7}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.42]{15_8}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.82]{15_9}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{15_10}
\end{figure}
